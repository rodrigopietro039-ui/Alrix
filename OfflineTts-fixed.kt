...
class OfflineTts(
    ...
    companion object {
        init {
            // Load shared dependencies explicitly. On some Samsung/32-bit Android
            // loaders, relying only on DT_NEEDED causes the JNI class initializer
            // to fail before the model/assets are even inspected.
